...
Use the `scan` command with the `-n` (or `--number`) option.-h7771872806

```
phoneinfoga scan -n "+1 (777) 187-2806"
phoneinfoga scan -n "+17771872806"
phoneinfoga scan -n "7771872806"
```

Special chars such as `( ) - +` will be escaped so typing US-based numbers stay easy : 

```
phoneinfoga scan -n "+1 7771872806"
```
...
```
phoneinfoga scan -n +17771872806-s footprints
```
...
```
phoneinfoga recon -n +7771872806
```
-->
